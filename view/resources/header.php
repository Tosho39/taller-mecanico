            ...
            <div id="leftside-navigation" class="nano">
                <ul class="nano-content">
                    ...
                    <li class="<?php if(isset($active4)){echo $active4;}?>">
                        <a href="./?view=taller"><i class="fa fa-indent"></i><span>Proveedor</span></a>
                    </li>
                    <?php } ?>
                    ...
                    <li class="<?php if(isset($active6)){echo $active6;}?>">
                        <a href="./?view=empresas"><i class="fa fa-building-o"></i><span>Categoria</span></a>
                    </li>
                    <?php } ?>
                    <?php if ($_SESSION['sector']==1) { ?>
                    <li class="<?php if(isset($active7)){echo $active7;}?>">
                        <a href="./?view=sectores"><i class="fa fa-road"></i><span>Repuesto</span></a>
                    </li>
                    <?php } ?>
